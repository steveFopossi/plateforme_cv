...
<body class="title-image">
			...
			<div class="row green-banner">
            	<div class="container main-container">
                	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                		<h4 class="white-heading">Modifiez votre offre</h4>
                    </div>
   ...
   <!-- full width section forms -->
    	<div class="container-fluid  contact_us">
        	<form  name="contact_us" id="form-style-2" method="POST" action="index.php?action=offres&ctrlaction=modifier_offre&id=<?php echo $infos_emploi[0]['ID_EMPLOI']?>">
                	...
                	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        	<div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            		<input type="text" name="titre_emploi" value="<?php echo $infos_emploi[0]['TITRE_EMPLOI']; ?>" required/>
                            	</div>
                            </div>
                            <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <select class="form-control"  name="secteur_emploi">
                                          <?php 
                                            foreach ($secteurs_emploi as $secteur) 
                                            {
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <select class="form-control"  name="type_contrat">
                                          <?php foreach ($types_contrat as $type_contrat) {
                                                ...
                                                {
                                                    if($type_contrat['ID_TYPE_CONTRAT']==$infos_emploi[0]['ID_TYPE_CONTRAT'])
                                                    {
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 ui-widget">
                                        <input type="text" name="ville" id="ville" value="<?php echo $nom_ville;?>"/>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                	<input type="number" name="salaire_min" value="<?php echo $infos_emploi[0]['SALAIRE_MIN']; ?>"/>
                           		</div> 
                            </div>
                            <div class="form-group">
                            	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                	<input type="number" name="salaire_max" value="<?php echo $infos_emploi[0]['SALAIRE_MAX']; ?>"/>
                           		</div> 
                            </div>
                     </div>
                </div>
                             ...
                             <div class="box box-info">
                                ...
                                <div class="box-body pad col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    ...
                                    <textarea id="editor1" name="description_emploi" rows="10" cols="80" required>
                                         <?php echo $infos_emploi[0]['DESCRIPTION'];?>
                                    </textarea>
